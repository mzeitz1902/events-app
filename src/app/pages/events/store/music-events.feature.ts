...
export const adapter: EntityAdapter<MusicEvent> =
  createEntityAdapter<MusicEvent>();
...
export const reducer = createReducer(
  ...
  on(loadMusicEventsSuccess, (state, action) =>
    adapter.setAll(action.musicEvents, { ...state, isLoading: false }),
  ),
);
