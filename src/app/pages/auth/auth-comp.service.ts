...
import {ControlEvent, FormBuilder, FormGroup, Validators} from "@angular/forms";
...
export class AuthCompService {
  ...
  emailEvents: Signal<ControlEvent<string | undefined> | undefined> = signal(undefined)
  passwordEvents: Signal<ControlEvent<string | undefined> | undefined> = signal(undefined)
